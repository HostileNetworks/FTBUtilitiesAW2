...
public class FTBUConfigGeneral
{
	...
	public static final ConfigEntryBool spawn_or_commonwealth_explosions = new ConfigEntryBool("spawn_and_commonwealth_explosions", false);
	
	@Info("If set to true, mobs in spawn area will be allowed")
	public static final ConfigEntryBool spawn_or_commonwealth_mobs = new ConfigEntryBool("spawn_and_commonwealth_mobs", false);
	
	@Info("If set to false, players won't be able to attack each other in spawn area")
	public static final ConfigEntryBool spawn_or_commonwealth_pvp = new ConfigEntryBool("spawn_and_commonwealth_pvp", true);
